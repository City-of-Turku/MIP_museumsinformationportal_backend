...
class YksikkoTalteenottotapaController extends Controller
{
	/**
	 * Get all talteenottotapa of a unit
	 *
	 * @param $unit_id
	 */
	public function forYksikko($yksikko_id) {
		...
		try {
			$queryBuilder = YksikkoTalteenottotapa::withYksikkoId($yksikko_id);
