...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \Fruitcake\Cors\HandleCors::class, // https://github.com/fruitcake/laravel-cors
    ];
    ...
    protected $routeMiddleware = [
    	 ...
    	 * -> jwt on tehty OMAKSI middlewareksi, jotta voidaan kaantaa tekstit sekä palauttaa MIPJson muotoinen json objekti
