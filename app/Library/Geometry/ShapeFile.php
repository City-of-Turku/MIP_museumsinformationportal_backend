...
/**
 * MUOKATTU METODIA parsePolygon()
 * Alkuperäisen luokan metodin overridaus ei onnistunut, tämän takia kopioitu tarvittavat tiedostot (ShapeFile.php ja ShapeFileException.php) tähän, sekä oheistavarat gasparesganga-kansioon.
 */
//namespace ShapeFile;
...
class ShapeFile implements \Iterator
{
    ...
    private function parsePolygon($data)
    {
        ...
        foreach ($data['parts'] as $rawpart) {
        	/*
        	 * HUOMIO
        	 * Tämä isClockwise tarkastus pitää kommentoida pois, muutoin esimerkkitiedosotn kuudesta 
        	 * polygonista jää 4 piirtämättä, ilman mitään kunnon syytä.
        	 */
